...
function SectionHeading({ eyebrow, title, subtitle, light = false }) {
  return (
    <div className="mb-10 text-center">
      ...
      {subtitle && (
        <p className={`mt-3 text-sm md:text-base max-w-lg mx-auto leading-relaxed ${light ? "text-gray-400" : "text-gray-500"}`}>
          {subtitle}
        </p>
      )}
    </div>
      ...
      <main className="font-sans bg-[#f9fafb]">
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="absolute inset-0 flex flex-col justify-center px-6 md:px-20 text-white">
            ...
            <motion.p {...fadeUp(0.32)} className="mb-8 max-w-md text-base md:text-lg text-gray-300 leading-relaxed">
            ...
            <motion.div {...fadeUp(0.52)} className="flex flex-wrap gap-3 mt-10">
              {stats.map(({ value, label }) => (
                <div key={label} className="stat-chip rounded-xl px-4 py-2.5 text-center">
                  <div className="text-lg font-extrabold text-yellow-400 leading-none">{value}</div>
        ...
        <section className="py-16 px-4 md:px-20">
          <div className="flex flex-col lg:flex-row items-start lg:items-end justify-between mb-12 gap-6 max-w-5xl mx-auto">
            ...
            <div className="flex items-center gap-2 shrink-0 flex-wrap">
              ...
              <Link href="/offerings"><span className="text-[13px] font-medium px-4 py-1.5 rounded-full bg-gray-100 text-gray-600 hover:bg-gray-200 cursor-pointer transition-colors">Top Rated</span></Link>
            </div>
          </div>
              ...
              <Link href={city.href} key={i}>
                ...
                >
                  <div className="relative w-28 h-28 mx-auto">
                    <img src={`/${city.img}`} alt={city.name} width={112} height={112}
        ...
        <section className="px-4 md:px-20 pb-16">
          <Link href="/Destination">
            <motion.div whileHover={{ y:-4 }} transition={{ duration:0.25 }}
              ...
              style={{ height:340 }}
            >
              <img src="/balloninluxor.jpg" alt="Balloon over Luxor"
                className="feature-img w-full h-full object-cover" />
              <div className="absolute inset-0"
                style={{ background:"linear-gradient(to top,rgba(0,0,0,.75) 0%,rgba(0,0,0,.1) 60%,transparent 100%)" }} />
              ...
              <div className="absolute bottom-0 left-0 right-0 p-7">
                <h3 className="text-3xl md:text-4xl font-extrabold text-white mb-2 leading-tight"
                  style={{ fontFamily:"'Playfair Display', serif" }}>LUXOR</h3>
              ...
              <Link href="/hidden-gems" key={i}>
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5">
                    ...
                    <h3 className="text-xl font-extrabold text-white leading-tight mb-1.5"
                      style={{ fontFamily:"'Playfair Display', serif" }}>{gem.title}</h3>
          ...
          <div className="rounded-3xl px-6 md:px-12 py-14 relative overflow-hidden"
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mt-10 pt-8 border-t border-white/10">
                ...
                <p className="text-gray-400 text-sm">based on 2,400+ verified reviews</p>
              </div>
            </div>
          </div>
        </section>
                ...
                >
                  ...
                  <div className="flex flex-col justify-between p-5 flex-1">
                    <div>
                      ...
                      <h3 className="font-bold text-base text-gray-900 leading-snug mb-3"
                        style={{ fontFamily:"'Playfair Display', serif" }}>
                        {story.title}
                      </h3>
                    </div>
        ...
        <section className="px-4 md:px-20 pb-20">
          <div className="rounded-3xl overflow-hidden relative"
            style={{ background:"linear-gradient(135deg,#06122e 0%,#0b1f46 50%,#102554 100%)", padding:"3rem" }}>
            <div className="absolute top-0 right-0 pointer-events-none"
              style={{ width:400, height:400,
                background:"radial-gradient(circle,rgba(255,206,42,.12) 0%,transparent 70%)",
        ...
        ══════════════════════════════════════════ */}
        <section className="px-4 md:px-20 pb-20">
          <div className="rounded-3xl text-center px-6 py-14 relative overflow-hidden"
            style={{ background:"linear-gradient(135deg,#FFCE2A 0%,#f5c000 50%,#e8a800 100%)" }}>
            {/* decorative circles */}
            <div className="absolute left-0 top-0 w-64 h-64 rounded-full pointer-events-none"
              style={{ background:"rgba(255,255,255,0.12)", transform:"translate(-80px,-80px)" }} />
            <div className="absolute right-0 bottom-0 w-48 h-48 rounded-full pointer-events-none"
              style={{ background:"rgba(255,255,255,0.10)", transform:"translate(60px,60px)" }} />
            ...
            <div className="relative z-10 max-w-xl mx-auto">
              ...
              <p className="mt-4 text-xs text-yellow-900/50">No spam. Unsubscribe anytime. Join 8,000+ subscribers.</p>
            </div>
          </div>
        </section>
