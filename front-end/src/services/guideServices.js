...
export async function getGuideRequiredTrips() {
  const res = await fetch("/api/guideDashboard/guideRequiredTrips", {
    credentials: "include",
  });
...
export async function getGuideFee() {
  const res = await fetch("/api/guideDashboard/guideFee", {
    credentials: "include",
  });
...
export async function setGuideSchedule(payload) {
  const res = await fetch("/api/guideDashboard/setGuideSchedule", {
    method: "POST",
