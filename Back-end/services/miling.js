...
const verifyEmailTemplate = (name, verifyURL) => `
  <div style="font-family: Arial, sans-serif; color: #333;">
    ...
    <a href="${verifyURL}" style="display: inline-block; background-color: #decb00; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Verify Email</a>
